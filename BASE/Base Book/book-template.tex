...
\title{\Huge \textbf{As sereias Gemeas}  \\ \huge A históra das Irmãs Separadas}
% Author
\author{\textsc{Mel Rodrigues}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{dedication}
Os agracecimentos a todos que me ajudarama escrever este livro.
\end{dedication}
...
\begin{chapquote}{Autor, \textit{Emmanuel}}
...
\section{A vida no mar}

Desde muito pequena vivendo em um lugar muito bonito e aconxegante, Mel, morava com sua mãe, que a protegia muito, de um jeito que ninguem entendia. Muitas vezes mel se sentia até prisioneira em sua propria casa, de tanto que sua a mãe  a protegia.
